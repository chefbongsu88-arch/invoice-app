...
async function main() {
  ...
  if (!markers.includes("image_pipeline=receipt-share-v2")) {
    console.error("FAIL: dist/index.mjs missing image_pipeline=receipt-share-v2");
  ...
  console.log("OK: dist/index.mjs contains receipt-share-v2 export marker");
